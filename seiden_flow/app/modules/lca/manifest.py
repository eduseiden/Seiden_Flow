...
MANIFEST = ModuleManifest(
    ...
    capabilities=("device_discovery", "spatial_configuration", "channel_configuration", "interaction_context", "relevant_event_processing", "lighting_sessions", "usage_analytics", "route_evidence", "device_lifecycle_management", "device_exclusions"),
