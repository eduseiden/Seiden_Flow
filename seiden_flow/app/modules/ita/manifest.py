...
MANIFEST = ModuleManifest(
    ...
    capabilities=("thermal_state", "thermal_deltas", "native_thresholds", "thermal_headroom", "telemetry_freshness", "fan_balance", "power_context", "trends", "events", "history", "asset_lifecycle", "vendor_agnostic"),
