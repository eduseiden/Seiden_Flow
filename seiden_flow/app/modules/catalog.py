...
from modules.ita.manifest import MANIFEST as ITA_MANIFEST
from modules.era.manifest import MANIFEST as ERA_MANIFEST


def build_module_registry() -> ModuleRegistry:
    registry = ModuleRegistry()
    registry.register_many((HEA_MANIFEST, EEA_MANIFEST, TCA_MANIFEST, LCA_MANIFEST, ITA_MANIFEST, ERA_MANIFEST))
    return registry
